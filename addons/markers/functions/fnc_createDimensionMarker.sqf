 ...
 *
 *  Parameter(s):
 *      0: STRING - Unique marker prefix.
 *      1: ARRAY - Position where the marker will be placed.
 *      2: ARRAY - Land Unit specific marker configuration.
 ...
 *      3: NUMBER - Scale of the marker. (Optional, default: 1.3)
 *      4: NUMBER - Alpha of the marker. (Optional, default: 1)
 *
 *  Returns:
